...
use Kaliop\eZMigrationBundle\DependencyInjection\CompilerPass\RegisterTwigNamespaceCompilerPass;
...
class eZMigrationBundle extends Bundle
{
    public function build(ContainerBuilder $container)
    {
        ...
        $container->addCompilerPass(new RegisterTwigNamespaceCompilerPass());
    }
}
